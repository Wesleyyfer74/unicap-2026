...
import { authenticate, authorizeAdmin, authorizeChamadaAccess } from '../middlewares/auth.middleware.js';
import { validate } from '../middlewares/validate.middleware.js';
import { chamadaDetailsSchema, chamadaIdSchema, createChamadaSchema, createPresencaSchema, listChamadasSchema, listPresencasChamadaSchema, removePresencaSchema, scannerAlunoSchema, searchAlunosChamadaSchema, updateChamadaSchema } from '../validators/chamada.validator.js';
...
router.put('/:id', authorizeAdmin, validate(updateChamadaSchema), chamadaController.update);
router.delete('/:id', authorizeAdmin, validate(chamadaIdSchema), chamadaController.remove);
