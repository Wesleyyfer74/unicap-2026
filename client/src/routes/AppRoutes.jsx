...
export default function AppRoutes() {
  return <BrowserRouter><Routes><Route element={<PublicLayout />}><Route path="/" element={<HomePage />} /></Route><Route path="/admin/login" element={<LoginPage />} /><Route element={<ProtectedRoute />}><Route path="/admin" element={<AdminLayout />}><Route index element={<DashboardPage />} /><Route path="fiscais" element={<FiscaisPage />} /><Route path="alunos" element={<AlunosPage />} /><Route path="chamadas" element={<ChamadasPage />} /><Route path="chamadas/:id" element={<ChamadaDetailsPage />} /><Route path="chamadas/:id/viagem" element={<ViagemFormPage />} /><Route path="chamadas/:id/scanner" element={<Suspense fallback={<main className="centered-page"><p>Carregando scanner...</p></main>}><ChamadaScannerPage /></Suspense>} /><Route path="ocorrencias" element={<OcorrenciasPage />} /><Route path="historico" element={<HistoricoPage />} /><Route path="relatorios" element={<RelatoriosPage />} /></Route></Route><Route path="*" element={<Navigate to="/" replace />} /></Routes></BrowserRouter>;
}
