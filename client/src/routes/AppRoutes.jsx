...
import FiscalLoginPage from '../pages/fiscal/FiscalLoginPage';
  ...
  return <BrowserRouter><Routes>
    ...
    <Route element={<ProtectedRoute />}>
      <Route path="/admin" element={<AdminLayout />}>
        ...
        <Route path="fiscais" element={<AdminOnly><FiscaisPage /></AdminOnly>} />
        <Route path="alunos" element={<AlunosPage />} />
        <Route path="chamadas" element={<ChamadasPage />} />
        <Route path="chamadas/:id" element={<ChamadaDetailsPage />} />
        <Route path="chamadas/:id/viagem" element={<ViagemFormPage />} />
        <Route path="chamadas/:id/scanner" element={<Suspense fallback={<main className="centered-page"><p>Carregando scanner...</p></main>}><ChamadaScannerPage /></Suspense>} />
        <Route path="ocorrencias" element={<OcorrenciasPage />} />
        <Route path="historico" element={<AdminOnly><HistoricoPage /></AdminOnly>} />
        <Route path="relatorios" element={<AdminOnly><RelatoriosPage /></AdminOnly>} />
      </Route>
    </Route>
